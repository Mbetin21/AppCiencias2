...
import com.appciencias.algorithms.SecuencialExterno;
import com.appciencias.algorithms.SecuencialExterno.ResultadoBusqueda;
...
/**
 * Panel interactivo para búsqueda secuencial externa con visualización por bloques.
 */
public class SecuencialExternoPanel extends JPanel {
    ...
    private SecuencialExterno secuencialExterno;
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel titleLabel = new JLabel("Búsqueda Secuencial Externa");
        ...
        JTextArea description = new JTextArea(
                "Simula búsqueda secuencial sobre almacenamiento externo. "
                + "Los registros se distribuyen en bloques de disco y se recorren bloque por bloque.");
    ...
    private void handleInicializar() {
        ...
        try {
            secuencialExterno = new SecuencialExterno(n, longClave);
            highlightedBlock = -1;
            highlightedPos = -1;
            updateResultados("Estructura inicializada correctamente.\n" + secuencialExterno.obtenerInfo());
    ...
    private void handleInsertar() {
        ...
        try {
            secuencialExterno.insertar(clave);
            highlightedBlock = -1;
            highlightedPos = -1;
    ...
    private void handleBuscar() {
        ...
        ResultadoBusqueda resultado = secuencialExterno.buscar(clave);
        ...
        updateResultados(secuencialExterno.obtenerInfo() + "\n" + resultado);
        claveField.setText("");
        refreshDrawPanel();
    }
    ...
    private void handleEliminar() {
        ...
        try {
            secuencialExterno.eliminar(clave);
            highlightedBlock = -1;
            highlightedPos = -1;
    ...
    private class BloquesDrawPanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            ArrayList<ArrayList<String>> bloques = secuencialExterno != null
                    ? secuencialExterno.obtenerBloques()
                    : new ArrayList<>();
            ...
            int slotsPorBloque = Math.max(1, secuencialExterno.getTB());
        ...
        public Dimension getPreferredSize() {
            int bloques = secuencialExterno != null ? secuencialExterno.getNumBloques() : 1;
            int slotsPorBloque = secuencialExterno != null ? Math.max(1, secuencialExterno.getTB()) : 1;
            int blockHeight = calculateBlockHeight(slotsPorBloque);
